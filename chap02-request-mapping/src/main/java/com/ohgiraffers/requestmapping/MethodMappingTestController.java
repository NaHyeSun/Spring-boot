...
*  그 과정은 컨트롤러 클래스의 핸들러 메서드에 선언된 다양한 @rRequestMapping 설정 내용에 따른다.
* */
@Controller
public class MethodMappingTestController {
    ...
    public String registMenu(Model model) {
        ...
        /* Model 객체에 addAttribute 메서드를 이용해 key, value를 추가하면 view에서 사용 할 수 있다.
        *  view-resolver에서 다시 다룬다.*/
         ...
         * resources/templates 하위로부터의 경로를 작성한다. */
